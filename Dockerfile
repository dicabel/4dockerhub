...
RUN mkdir /var/www/html/protegido && chown -R www-data /var/www/html/protegido && chmod 755 /var/www/html/protegido & chmod 777 -R /var/www/html/
...
#COPY .htaccess /var/www/html/protegido/

RUN htpasswd -c -b /etc/apache2/.htpasswd mario 'qwerty'
